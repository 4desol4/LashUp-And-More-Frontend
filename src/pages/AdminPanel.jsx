...
const AdminPanel = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'overview':
        return <OverviewSection stats={stats} bookings={bookings} orders={orders} />;
      case 'bookings':
        return <BookingList isAdmin={true} />;
      case 'orders':
...
const OverviewSection = ({ stats, bookings, orders }) => {
          ...
          return (
            ...
            >
              <Card className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium font-three text-gray-600 dark:text-gray-400">
                      {stat.name}
                    </p>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-3">
            {recentBookings.length === 0 ? (
              <p className="text-gray-500 dark:text-gray-400 text-sm font-one">
                No recent bookings
              </p>
            ) : (
              recentBookings.map((booking) => (
                <div key={booking.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-charcoal-700 rounded-lg">
                  <div>
          ...
          <div className="space-y-3">
            {recentOrders.length === 0 ? (
              ...
              recentOrders.map((order) => (
                <div key={order.id} className="flex items-center font-three justify-between p-3 bg-gray-50 dark:bg-charcoal-700 rounded-lg">
                  <div>
