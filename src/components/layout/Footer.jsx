...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-charcoal-900 border-t border-gray-200 dark:border-charcoal-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {/* Bottom Section */}
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200 dark:border-charcoal-700">
